...
var tabs_Default = {
  defaultTabId: null,
  activeClasses: 'main-bg-ud text-white hover:text-grey-200 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500',
    ...
    value: function show(id) {
      ...
      this._items.map(function (t) {
        if (t !== tab) {
          ...
          t.triggerEl.children[0].classList.add('bbbb');
      ...
      tab.triggerEl.children[0].classList.add('text-whte');
      tab.triggerEl.children[0].classList.remove('bbbb');
